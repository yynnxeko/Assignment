...
public class SearchCarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (sale == null) {
                request.setAttribute("ERROR", "Bạn cần login để thực hiện các tính năng");
                request.getRequestDispatcher("MainServlet?action=home").forward(request, response);
            } else {
                String carSearchSerial = request.getParameter("carSearchSerial");
                String carSearchModel = request.getParameter("carSearchModel");
                String carSearchYear = request.getParameter("carSearchYear");
                int year = Integer.parseInt(carSearchYear);
